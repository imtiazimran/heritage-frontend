...
const Feature = () => {
  return (
    <Container className="py-8 my-10  ">
      {/* First Section */}
      <div className="flex flex-wrap justify-between gap-32 md:gap-0 items-center mb-10 h-screen my-28 md:my-0">
        {/* Background Image */}
      ...
      {/* Second Section */}
      <div className="flex flex-wrap flex-row-reverse justify-between gap-20 md:gap-0 items-center mb-10 h-screen mt-56 my-28 md:my-0 md:mt-0">
      ...
      {/* Third Section */}
      <div className="flex flex-wrap justify-between flex-row md:flex-row gap-32 md:gap-0 items-center mb-10 h-screen mt-56 md:mt-0 my-28 md:my-0">
        {/* Background Image */}
        <div className="w-full md:w-1/2 h-64 relative mb-8 md:mb-0">
          <img
            src="https://bandaproperty.com/wp-content/uploads/2023/03/Perry-Street_Living-Room_040-scaled.jpg"
