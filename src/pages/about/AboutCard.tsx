...
const AboutCard = () => {
  return (
    <Container className="py-10">
      {/* Our Story Section */}
      <div className="relative h-auto lg:h-[583px] flex flex-col lg:flex-row">
        <div
          className="relative w-full lg:w-[70%] h-[300px] lg:h-full bg-no-repeat bg-cover bg-center z-10"
          style={{
        ...
        <div className="absolute inset-0 w-full lg:w-[50%] h-[200px] lg:h-auto bg-accent top-1/2 lg:top-auto lg:left-1/2 px-4 z-50 transform lg:-translate-x-1/2 lg:-translate-y-1/2">
          <div className="flex items-center gap-2 mt-4">
            <div className="w-8 border h-[1px] border-secondary"></div>
            <p className="text-secondary font-semibold">Our Story</p>
          </div>
          <h1
            className="text-title text-[24px] lg:text-[36px font-bold"
      ...
      <div className="relative h-auto lg:h-[583px] flex flex-col lg:flex-row-reverse mt-10">
        ...
        <div className="absolute inset-0 w-full lg:w-[50%] h-[200px] lg:h-auto bg-accent top-1/2 lg:top-auto lg:right-1/2 px-4 z-50 transform lg:translate-x-1/2 lg:-translate-y-1/2">
          <div className="flex items-center gap-2 mt-4">
            <div className="w-8 border h-[1px] border-secondary"></div>
